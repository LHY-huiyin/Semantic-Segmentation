...
class DeepLab_SEBIFPN_EaNet(nn.Module):
    def __init__(self, backbone='resnet', output_stride=16, num_classes=8,
        ...
        super(DeepLab_SEBIFPN_EaNet, self).__init__()  # 自己搭建的网络Deeplab会继承nn.Module：
    ...
    def forward(self, x):
        ...
        logits = self.decoder(feat2, feat4, feat8, feat16, feat_lkpp)  # p2_in p2_out:[4,256,96,96]
        "进行4倍上采样"
...
if __name__ == "__main__":
    ...
    model = DeepLab_SEBIFPN_EaNet(backbone='resnet', output_stride=16)
