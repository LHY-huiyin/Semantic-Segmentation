...
class EDA(nn.Module):
    def __init__(self, in_planes, out_planes, kernel_size=3, stride=1, padding=0, dilation=1, groups=1, relu=True,
        ...
        self.conv_1 = nn.Conv2d(in_planes, out_planes, kernel_size=1)
        self.conv_2 = nn.Conv2d(in_planes, out_planes, kernel_size=1)
        self.conv_3 = nn.Conv2d(in_planes, out_planes, kernel_size=1)
...
if __name__ == "__main__":
    ...
    model = EDA(in_planes=3, out_planes=256)
