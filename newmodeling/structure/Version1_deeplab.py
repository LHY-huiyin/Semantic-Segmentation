...
from newmodeling.structure.Version1_decoder import *
...
class Version1(nn.Module):
    def __init__(self, backbone='resnet', output_stride=16, num_classes=8,
        ...
        super(Version1, self).__init__()  # 自己搭建的网络Deeplab会继承nn.Module：
    ...
    def forward(self, x):
        ...
        logits = self.decoder(x1, x2, x3, x4)  # p2_in p2_out:[4,256,96,96]
        "进行4倍上采样"
...
if __name__ == "__main__":
    ...
    model = Version1(backbone='resnet', output_stride=16)
