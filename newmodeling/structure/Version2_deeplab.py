...
from newmodeling.structure.Version2_decoder import *
...
"总体架构"
class Version2(nn.Module):
    def __init__(self, backbone='resnet', output_stride=16, num_classes=8,
                 sync_bn=True, freeze_bn=False):
        super(Version2, self).__init__()  # 自己搭建的网络Deeplab会继承nn.Module：
...
if __name__ == "__main__":
    ...
    model = Version2(backbone='resnet', output_stride=16)
