from modeling.backbone import resnet, xception, drn, mobilenet, ghostnet_rectify, resnetxt_cifar, resnetxt, mobilenet_origin, ghostnet_origin, resnet50

def build_backbone(backbone, output_stride, BatchNorm):  # 'resnet' 16
    if backbone == 'resnet':  # 16
        # return resnet.ResNet101(output_stride, BatchNorm)
        return resnet50.ResNet50(output_stride, BatchNorm)
