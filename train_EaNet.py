...
from newmodeling.articlecode.EaNet import *
from utils.loss import ECELoss
...
class Trainer(object):
    ...
    def validation(self, epoch):
        ...
        # 保存文件
        with codecs.open('实验记录resnet101_EaNet.txt', 'a', 'utf-8') as f:
        ...
        if new_pred >= 0.50:  # MIOU
            for i, sample in enumerate(tbar):
                ...
                for j in range(20):
                    ...
                    # plt.axis('off')
                    "opencv保存彩色图片"
                    image_name = "./RESULT/EaNet/" + str(i) + '_' + str(j) + '.jpg'
                    segmap = segmap[:, :, ::-1] * 255
...
def main():
    ...
    parser.add_argument('--batch-size', type=int, default=20,  # 2,4,8,12,14
