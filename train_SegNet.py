...
from newmodeling.articlecode.SegNet import *
...
class Trainer(object):
    def __init__(self, args):
        ...
        # optimizer = torch.optim.SGD(SegNet.parameters(), lr=0.035, momentum=args.momentum,
    ...
    def validation(self, epoch):
        ...
        # 保存文件
        with codecs.open('./实验记录SegNet.txt', 'a', 'utf-8') as f:
        ...
        if new_pred >= 0.2:  # MIOU
            for i, sample in enumerate(tbar):
                ...
                for j in range(2):
                    ...
                    # plt.axis('off')
                    "opencv保存彩色图片"
                    image_name = "./RESULT/SegNet" + str(i) + '_' + str(j) + '.jpg'
                    segmap = segmap[:, :, ::-1] * 255
