...
from newmodeling.articlecode.MACU_Net import *
...
class Trainer(object):
    ...
    def validation(self, epoch):
        ...
        # 保存文件
        with codecs.open('实验记录resnet101_MACUNet_lovada.txt', 'a', 'utf-8') as f:
        ...
        if new_pred >= 0.42:  # MIOU
            for i, sample in enumerate(tbar):
                ...
                for j in range(16):
                    ...
                    # plt.axis('off')
                    "opencv保存彩色图片"
                    image_name = "./RESULT/MACUNet/" + str(i) + '_' + str(j) + '.jpg'
                    segmap = segmap[:, :, ::-1] * 255
