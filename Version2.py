...
from newmodeling.structure.Version2_deeplab import *
...
class Trainer(object):
    def __init__(self, args):
        ...
        # Define network
        model = Version2(backbone=args.backbone, output_stride=args.out_stride)
    ...
    def validation(self, epoch):
        ...
        # 保存文件
        with codecs.open('../实验记录Version2.txt', 'a', 'utf-8') as f:
